...
export class Quiz {
    constructor() {
        this.questionsSets = {
            'math': [
                new Question('1', 'В какую из этих игр играют не клюшкой?', ['Бильярд', 'Хоккей', 'Гольф', 'Поло'], 1),
                new Question('2', 'Как называется детеныш норки?', ['Котенок','Щенок', 'Белек', 'Норик'], 1),
                new Question('3', 'Где муха-цокотуха нашла денежку?', ['На лугу,', 'Во дворе', 'В поле', 'Во дворе'], 2),
                new Question('4', 'Как называют брата жены?', ['Кум', 'Деверь', 'Свояк', 'Шурин'], 3),
                new Question('5', 'Какой из языков программирования является декларативным?', ['Pascal', 'C#', 'SQL', 'Lisp'], 2),
            ]
        };
